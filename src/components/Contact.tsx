        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-foreground/80 leading-relaxed mb-8">
              Whether you want to discuss a potential collaboration, talk about
              secure full-stack architectures, or just say hi, my inbox is
          ...
          >
            <div className="flex flex-col gap-1.5">
              <label
                htmlFor="name"
                className="text-sm font-semibold text-foreground/80 ml-2"
              >
                Name
              </label>
              <input
