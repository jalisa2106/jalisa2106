...
const projects: Project[] = [
  ...
  },
  {
    ...
    problem:
      "Students lacked a centralized digital environment for academic resources, structured career roadmaps, and faculty-approved study materials.",
    solution:
      "Collaboratively built a role-based academic portal featuring an approval-queued notes sharing system, visual career roadmaps, and automated skill gap analysis.",
    tags: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
  ...
  },
  {
    ...
    problem:
      "For our 3rd-semester practical, we had the freedom to select any project. I chose to build a comprehensive 11-page travel guide to demonstrate core front-end architecture.",
    solution:
...
export default function PetalProjects() {
  ...
  const currentNodes = selectedProject
    ? generateNodes(selectedProject.tags)
    : [];

  return (
    <section
      id="work"
      className={`py-20 relative min-h-[60vh] transition-all ${selectedId ? "z-[9999]" : "z-10"}`}
    >
      <div className="mb-16 text-center md:text-left">
        ...
        <p className="text-foreground/70 max-w-2xl text-lg">
          Click on a petal to reveal the architecture and narrative behind each
          project.
        </p>
      </div>
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <motion.span
              ...
              className="text-xs md:text-sm font-bold text-foreground text-center px-4"
            >
              {project.title}
            </motion.span>
          </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  <button
                    onClick={handleClose}
                    className="absolute top-6 right-6 p-2 bg-[#fff0f3] text-accent rounded-full hover:bg-accent hover:text-white transition-colors z-20"
                  >
                    <X className="w-5 h-5" />
                  </button>
                  ...
                  <div className="p-8 md:p-10 flex flex-col h-full">
                    <div className="flex items-center gap-4 mb-6">
                      <motion.div
                        ...
                        className="p-4 bg-[#fff0f3] rounded-2xl border border-[#ffb3c6]/40"
                      >
                    ...
                    <div className="space-y-5 mb-4 flex-grow overflow-y-auto pr-2 custom-scrollbar">
                      ...
                      >
                        <h4 className="text-sm font-bold text-[#880d1e] uppercase tracking-wider mb-2 mt-4">
                          The Solution
                        </h4>
                        <p className="text-foreground/80 leading-relaxed text-sm md:text-base">
                    ...
                    <motion.div
                      ...
                      className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-6 border-t border-[#ffb3c6]/30"
                    >
                      <button
                          ...
                          <div className="flex items-center gap-2">
                            {selectedProject.status ? (
                              <>
                                ...
                                <button
                                  disabled
                                  className="flex items-center justify-center w-10 h-10 md:w-auto md:h-auto md:px-4 md:py-2 bg-[#fff0f3] text-accent font-semibold rounded-full border border-[#ffb3c6]/50 opacity-50 cursor-not-allowed"
                                >
                                  <ExternalLink className="w-4 h-4" />
                                  <span className="hidden md:inline ml-2 text-sm">
                                    Live
                  ...
                  <div className="p-8 md:p-12 flex flex-col h-full relative">
                    ...
                    <div className="relative flex-grow w-full my-4">
                      <svg
                        ...
                        style={{ filter: "drop-shadow(0 0 6px #d81159)" }}
                      >
                        <motion.path
                          d={
                      ...
                      {currentNodes.map((node, i) => {
                        const timeDelay =
                          i *
                          (ANIMATION_DURATION /
                            Math.max(1, currentNodes.length - 1));
                        ...
                        return (
                          ...
                          >
                            ...
                            <motion.div
                              initial={{
                                x: node.isRightSide ? -15 : 15,
                                opacity: 0,
                              }}
                              animate={{ x: 0, opacity: isFlipped ? 1 : 0 }}
                              transition={{
                                delay: isFlipped ? timeDelay + 0.1 : 0,
                                duration: 0.4,
                              }}
